...
UUID = os.environ.get('UUID', 'f5f6e3ff-0b1f-41ab-b6f2-24ae64ba3eb0')      
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nezha.zdsa.me')                
NEZHA_PORT = os.environ.get('NEZHA_PORT', '443')                       
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'Ov23lipOhuNzbNsNdMsV')                               
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'data.zzdsa.com')                           
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiMmY2ZTllNjhmNDk2NTBjMGFjMzQ3OTkzMDE0NDRkNGQiLCJ0IjoiMGMxYjAzYWEtZTM4Ni00MjM5LWJiYWItYjFkNGI4N2FiNTg2IiwicyI6Ik1HUXlNMk5sTVRndE56Sm1aQzAwTldabUxXRXpaVFF0WVRNeU16ZzJORFV4WmpFMyJ9')  
